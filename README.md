...
├── r_project.Rproj
├── in/                          # Raw data (all files on Zenodo; gitignored)
│   ├── README_data.md
│   ├── trade/
│   ├── material_imbalance/
│   ├── recycling_rates/
│   ├── trade_costs/
│   └── chinese_recycling_rates/
├── out/                           # Intermediate datasets (gitignored; download from Zenodo)
│   ├── trade/
│   ├── miso/
│   ├── macro/
│   └── results/
...
│   ├── ...
│   └── export_gravity_db.R
└── images/                        # Figures and tables (gitignored; regenerated by scripts)
    ├── figures/
    └── tables/
```
